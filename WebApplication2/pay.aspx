<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pay.aspx.cs" Inherits="WebApplication2.pay" %>
...
<div id="wrapper">
	...
	<header>
        ...
        <div class="navbar navbar-default navbar-static-top">
			...
			<li><a href="<% =ConfigurationManager.AppSettings["paylink"]     %>">Pay</a></li>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-6">
				<h4>Transaction ID (CSC PG)</h4>
				<h1>txn ID</h1>
				<h2>Date: </h2>
				<h3>Amount: <%=walletResponseMessage %> </h3>
				<h4>Invoice:</h4>
